...
```tsx
{
  ...
  description: [
    "Designed and executed manual test cases to validate software features and user interface components. Performed API testing using Postman to verify endpoint functionality and data accuracy. Created and maintained testing documentation, test reports, and issue tracking records. Identified, documented, and reported software defects throughout the development lifecycle. Collaborated closely with developers and QA engineers using Jira to track bug resolution and improve software quality. Participated in software validation activities and contributed to quality assurance processes within an Agile development environment.",
  ]
}
```
