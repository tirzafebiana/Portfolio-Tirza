...
const Appreman = lazy(() => import('./pages/projects/appreman'))
const Finance = lazy(() => import('./pages/projects/finance'))
const ChickWise = lazy(() => import('./pages/projects/chickwise'))
const Ukmeuro = lazy(() => import('./pages/projects/ukmeuro'))
        ...
        <main id="main-content" className="main-content">
          <Suspense fallback={<div className="flex items-center justify-center min-h-screen">Loading...</div>}>
            <Routes>
              ...
              <Route path="/projects/project-one" element={<Appreman />} />
              <Route path="/projects/project-two" element={<Finance />} />
              <Route path="/projects/project-three" element={<ChickWise />} />
              <Route path="/projects/project-four" element={<Ukmeuro />} />
            </Routes>
          </Suspense>
        </main>
