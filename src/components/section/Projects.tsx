...
import { appremanIcon, financeIcon, chickwiseIcon, euroIcon } from '../../assets/project_icons';
...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Appreman -  Internship Attendance App",
      description: "Mobile-based attendance system for interns at BLSDM Komdigi Manado. Built with Flutter frontend and Laravel REST API backend. Features include check-in/out, real-time monitoring, automated reporting, and role-based access for interns and coordinators. Replaced manual paper-based attendance with a digital system.",
    ...
    },
    {
      ...
      description: "Web-based internal applications for financial data management (SPBY and BKU systems) at BLSDM Komdigi Manado. Built using Google Apps Script and JavaScript to automate financial reporting, data entry, and document management. Reduced manual work by streamlining administrative processes.",
    ...
    {
      title: "ChickWise — IoT Smart Poultry System",
      description: "IoT-based environmental monitoring system for poultry farms. Uses ESP32 with DHT22 and MQ135 sensors to monitor temperature, humidity, and ammonia levels in real-time, visualized through ThingsBoard Cloud dashboard. Team project completed remotely during MSIB Independent Study program.",
      technologies: ["ESP32", "DHT22", "MQ135","C++","ThingsBoard Cloud"],
      icon: chickwiseIcon,
      detailsUrl: "/projects/project-three",
      githubUrl: socialLinks.repositories.projectThree
    },
    {
      title: "UKM Edukasi Robotika — Organization Website",
      description: "Informational website for robotics education student organization at Universitas Sam Ratulangi. Built with HTML, CSS, and JavaScript to showcase organizational activities, events, and robotics projects. Created as a portfolio project for the organization.",
